...
describe('CourseActions', () => {
  ...
  it('calls the dispatcher with a select action', () => {
    const selectedCourse = courseData.courses[2]
  ...
  it('calls the dispatcher with an unselect action', () => {
    const unselectedCourse = courseData.courses[2]
...
describe('CourseStore', () => {
  ...
  const dispatcherCallback = AppDispatcher.register.mock.calls[0][0]
  ...
  describe('on receiving filter action', () => {
    ...
    it('filters the courses', () => {
      ...
      const filterResult = eventReceiver.mock.calls[0][0]
